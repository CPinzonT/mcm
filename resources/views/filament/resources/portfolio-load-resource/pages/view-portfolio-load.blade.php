...
<div class="ops-shell">
    <section class="ops-hero ops-hero--compact">
        <div>
            <div class="ops-hero-kicker">Detalle de cartera</div>
    ...
    <section class="ops-metric-strip" aria-label="Resumen de la carga de cartera">
        ...
        <article class="ops-metric">
            ...
            <div class="ops-metric-value">{{ number_format($record->document_count) }}</div>
            <div class="ops-metric-sub">Procesados en cartera</div>
        </article>
        <article class="ops-metric">
            <div class="ops-metric-label">Saldo</div>
            <div class="ops-metric-value">${{ number_format($record->total_pending_amount, 0, ',', '.') }}</div>
