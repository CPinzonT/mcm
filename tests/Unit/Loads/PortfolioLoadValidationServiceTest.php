...
class PortfolioLoadValidationServiceTest extends TestCase
{
    ...
    public function test_it_detects_a_collection_file_loaded_in_portfolio_module(): void
    {
        ...
        $service = new PortfolioLoadValidationService(
            ...
            $periodControl,
            new \App\Services\Risk\RiskClassificationService(),
        );
    ...
    {
        $path = $this->createCsv([
            ['cuenta', 'cliente', 'nit', 'nro_documento', 'tipo', 'fecha_contabilizacion', 'fecha_vencimiento', 'valor_documento', 'valor_a_recaudar'],
            ['1001', 'Cliente Demo', '900123123', 'FAC-100', 'FACTURA', '2026-03-15', '2026-03-30', '150000', '150000'],
        ]);
    ...
    {
        $path = $this->createCsv([
            ['cuenta', 'cliente', 'nit', 'telefono', 'nro_documento', 'tipo', 'fecha_contabilizacion', 'fecha_vencimiento', 'valor_documento', 'valor_a_recaudar'],
            ['1001', 'Cliente Demo', '900123123', '3108600783-3108600783-3108600783', 'FAC-100', 'FACTURA', '2026-03-15', '2026-03-30', '150000', '150000'],
        ]);
    ...
    public function test_it_allows_same_document_number_for_different_clients(): void
    {
        $path = $this->createCsv([
            ['cuenta', 'cliente', 'nit', 'nro_documento', 'tipo', 'fecha_contabilizacion', 'fecha_vencimiento', 'valor_documento', 'valor_a_recaudar'],
            ['13050505', 'Cliente Uno', '900111111-1', '350094', 'AC', '2026-03-15', '2026-03-30', '100000', '100000'],
            ['13050505', 'Cliente Dos', '900222222-2', '350094', 'AC', '2026-03-15', '2026-03-30', '200000', '200000'],
        ]);
    ...
    public function test_it_accepts_a_forced_cutoff_period_when_document_dates_span_multiple_months(): void
    {
        $path = $this->createCsv([
            ['cuenta', 'cliente', 'nit', 'nro_documento', 'tipo', 'fecha_contabilizacion', 'fecha_vencimiento', 'valor_documento', 'valor_a_recaudar'],
            ['13050505', 'Cliente Uno', '900111111-1', '350094', 'AC', '2022-12-31', '2025-09-30', '100000', '100000'],
            ['13050505', 'Cliente Dos', '900222222-2', '350095', 'AC', '2024-12-30', '2025-09-30', '200000', '200000'],
        ]);
